...
test('Redis instrumentation: db statement is added when SPLUNK_REDIS_INCLUDE_COMMAND_ARGS is true', async () => {
  ...
  await new Promise<void>((resolve, reject) => {
    client.hget('foo', 'bar', async (err: any) => {
      ...
      assert.deepStrictEqual(span.attributes['db.query.text'], 'hget foo bar');
