...
} from '../../../../src/instrumentations/external/kafkajs';
  ...
  describe('consumer', () => {
    ...
    describe('successful eachBatch', () => {
      ...
      it('consume eachBatch create span with expected attributes', async () => {
        ...
        assert.strictEqual(
          recvSpan.attributes[SemanticAttributes.MESSAGING_OPERATION],
          'receive'
        );
        ...
        assert.strictEqual(
          msg1Span.attributes[SemanticAttributes.MESSAGING_OPERATION],
          'process'
        );
        ...
        assert.strictEqual(
          msg2Span.attributes[SemanticAttributes.MESSAGING_OPERATION],
          'process'
        );
      });
